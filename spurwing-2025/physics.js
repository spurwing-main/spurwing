// pageFunctions.addFunction("circlesJS", function () {
...
function main() {
	...
	if (!container) {
		console.error("Container .circles_sim not found");
		return;
	}
	...
	const initSimulation = async () => {
		...
		try {
			...
			const walls = [
				...
				Bodies.rectangle(-wallThickness / 2 + offset, height / 2, wallThickness, height, wallStyle), // left
				Bodies.rectangle(
